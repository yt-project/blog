...
issue on the yt blog [repository](https://github.com/yt-project/blog). All
...
follow these steps: 
1. Go to the [issues](https://github.com/yt-project/blog/issues) page of the yt blog 
   repository. 
...
Go to the yt blog [repository](https://github.com/yt-project/blog) and click
the fork button on the top right of the page. This will create a copy of the
repository under your username, e.g. https://github.com/crashoverride/blog . 

Next, clone the blog from your profile

``` bash
$ git clone git@github.com:crashoverride/blog.git
```
...
Cloning into '/Users/crashoverride/repos/blog/themes/dream'...
...
Built in 281 ms
Watching for changes in /Users/crashoverride/repos/blog/{content,static,themes}
Watching for config changes in /Users/crashoverride/blog/config.toml
...
Source changed "/Users/crashoverride/repos/blog/content/posts/mycoolpost.md": WRITE
Total in 32 ms
```
...
use on the blog page at https://yt-project.github.io/blog/ in the left
panel. 
